 ...
 * /link-building
 *
 * The copy below is the shipped default. An editor's saved changes layer over
 * it, and clearing a field in the editor restores what is written here, so
 * this file stays the safety net rather than becoming stale.
 */
...
export const definition: PageDef = {
  ...
  label: 'Link building',
  path: '/link-building',
  description: 'The main service page, targeting "link building services".',
...
export const defaults: PageValues = {
  hero: {
    ...
    intro:
      'Press Parrot turns link building from a sprawling outreach project into something you can actually manage. Search vetted publishers on real SEO metrics, see the price before you commit, and track every placement from brief to live URL.',
    ...
    sections: [
      {
        ...
        content: `Link building is the work of earning links from other websites to yours. Search engines still treat a link as a signal that someone found your page worth pointing at, which is why it remains one of the few ranking factors you can deliberately influence from outside your own site.
...
- Following up, tracking placements and reconciling invoices`,
      },
      {
        ...
        content: `We do the publisher wrangling so you can spend your time on strategy. Every site in the marketplace has already been vetted, priced and confirmed as accepting placements, which removes the discovery, qualification and negotiation stages entirely.

You filter down to the sites that fit your campaign, add them to an order, supply your target URL and anchor text, and track the order through to a live URL. If you want us to write the article too, add [content](/content-writing) to the same order rather than running a separate process.`,
      },
      {
        heading: 'What makes a high quality backlink',
        content: `Relevance comes first. A link from a mid-sized site that genuinely covers your subject usually does more than a link from a larger site that has no business mentioning you. Topical fit is what makes a link look earned rather than bought.
...
- An anchor that reads naturally in the sentence around it`,
      },
      {
        ...
        content: `[Guest posts](/guest-posts) give you a new article written around your subject, so you control the framing, the supporting points and where the link sits. They suit new pages and competitive terms where context matters.

[Niche edits](/niche-edits) place your link inside an article that already exists and is already indexed, which usually means a faster turnaround and an established page. [Digital PR](/digital-pr) works differently again: you are offering editorial value or expert commentary to a publication, and the coverage tends to carry more brand weight than a placement bought outright.`,
      },
      {
        heading: 'Building a link profile that holds up',
        content: `Spread acquisition across pages rather than pointing everything at one commercial URL, vary your anchors so the profile does not read as engineered, and keep a steady pace instead of buying a large batch in one month and then nothing for six.
  ...
  faqs: {
    items: [
      ...
      },
      {
        ...
        answer: 'No. Accounts are free and you only pay for the placements and content you order.',
      },
      {
