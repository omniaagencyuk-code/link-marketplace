...
import { Bookmark, LayoutDashboard, Menu, Search, ShoppingBag, X } from 'lucide-react';
            ...
            {user ? (
              <>
                ...
                <Link
                  ...
                  aria-label={`Order draft (${draftCount} items)`}
                  className="relative hidden h-8 w-8 items-center justify-center rounded-md text-ink-soft transition-colors hover:bg-surface-sunken hover:text-ink sm:inline-flex"
                >
                  <ShoppingBag className="h-4 w-4" />
                  {draftCount > 0 ? <CountDot value={draftCount} /> : null}
                </Link>
